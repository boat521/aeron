...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s aeron-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  aeron-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aeron transaction") + "\n" +
              "  aeron-tx [options] -create [commands]   " + _("Create hex-encoded aeron transaction") + "\n" +
              "\n";
