...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Aeron Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Aeron Core"
...
#define PACKAGE_BUGREPORT "https://github.com/aeron-project/aeron/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Aeron Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Aeron Core 0.14.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aeron"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://aeron.org/"
