...
const char * const BITCOIN_CONF_FILENAME = "aeron.conf";
const char * const BITCOIN_PID_FILENAME = "aeron.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Aeron";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Aeron";
#else
    // Unix
    return pathRet / ".aeron";
#endif
#endif
}
